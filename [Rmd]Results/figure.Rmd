...
figName = c("Fig1A","SupFig1","SupFig2","MS")
for(iFig in 1:(countFigNum-1)){
  CairoPDF(file=paste("figure/",figName[iFig],sep=""))
...
The two-way repeated measures ANOVA revealed a significant main effect on the pattern and VF locations 
...
$p$ = `r round(anovaTabAll[["data_anova_Late"]][["fig3b_ttest"]][3,]['adj.p'],3)` for upper vs.left; 
$t$(`r anovaTabAll[["data_anova_Late"]][["fig3b_ttest"]][4,]['df']`) = 
`r round(anovaTabAll[["data_anova_Late"]][["fig3b_ttest"]][4,]['t'],3)`, 
$p$ = `r round(anovaTabAll[["data_anova_Late"]][["fig3b_ttest"]][4,]['adj.p'],3)` for upper vs.left; 
$t$(`r anovaTabAll[["data_anova_Late"]][["fig3b_ttest"]][5,]['df']`) = 
`r round(anovaTabAll[["data_anova_Late"]][["fig3b_ttest"]][5,]['t'],3)`, 
$p$ = `r round(anovaTabAll[["data_anova_Late"]][["fig3b_ttest"]][5,]['adj.p'],3)` for upper vs.left; 
)
...
$\eta^2_p$ = `r round(anovaTabAll[["data_anova_Late"]][["fig3b_inter"]][5,]['p.eta^2'],3)` for Upper; 
...
$\eta^2_p$ = `r round(anovaTabAll[["data_anova_Late"]][["fig3b_inter"]][7,]['p.eta^2'],3)` for Lower; 
...
$\eta^2_p$ = `r round(anovaTabAll[["data_anova_Late"]][["fig3b_inter"]][9,]['p.eta^2'],3)` for Left; 
...
$\eta^2_p$ = `r round(anovaTabAll[["data_anova_Late"]][["fig3b_inter"]][11,]['p.eta^2'],3)` for Right
)
