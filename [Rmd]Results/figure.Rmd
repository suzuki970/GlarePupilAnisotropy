...
($F$(`r round(anovaTabAll[["data_anova_Late"]][["fig3b_inter"]][3,]['df.col'],3)`,
`r round(anovaTabAll[["data_anova_Late"]][["fig3b_inter"]][4,]['df.col'],3)`) = 
`r round(anovaTabAll[["data_anova_Late"]][["fig3b_inter"]][3,]['f.col'],3)`, 
$p$ = `r round(anovaTabAll[["data_anova_Late"]][["fig3b_inter"]][3,]['p.col'],3)`, 
$\eta^2_p$ = `r round(anovaTabAll[["data_anova_Late"]][["fig3b_inter"]][3,]['p.eta^2'],3)`) 
